...
const SignIn = () => {
  ...
  return (
    <section className="-mt-10 bg-gray-1 py-20 dark:bg-dark lg:py-[120px]">
          ...
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
              ...
              <form onSubmit={onSubmit}>
                ...
                ></input>
                {errors.email && (
                  <p className="text-red-500 text-xs -ml-72 -mt-3">
              ...
              <h1 className="mb-6 text-base text-secondary-color dark:text-dark-7">
                Connect With
              </h1>
